DROP        TABLE IF EXISTS sd_vektis_zorgkosten_2018
;

CREATE      TABLE sd_vektis_zorgkosten_2018 AS 
...
ANALYZE sd_vektis_zorgkosten_2018
;

--GRANT ALL 
--ON          TABLE sd_vektis_zorgkosten_2018 TO d2aportal
--;