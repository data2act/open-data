DROP        TABLE IF EXISTS sd_vektis_zorgkosten_2015
;

CREATE      TABLE sd_vektis_zorgkosten_2015 AS 
...
ANALYZE sd_vektis_zorgkosten_2015
;

--GRANT ALL 
--ON          TABLE sd_vektis_zorgkosten_2015 TO d2aportal
--;
